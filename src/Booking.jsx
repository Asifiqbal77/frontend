...
//   const { booking, setBooking } = useContext(BookingContext); // use booking context
...
//   // useEffect to update context whenever form changes
//   useEffect(() => {
//     setBooking(form); // store current booking globally
//   }, [form, setBooking]);
